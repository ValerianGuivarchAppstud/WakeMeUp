...
class ReveilEdit : AppCompatActivity() {
    ...
    private fun adaptTextDays(reveil: ReveilModel) {
        when (reveil.repetition) {
            ReveilModel.ReveilMode.PasDeRepetition -> textEditReveilJoursChoisis.text = "Pas de répétition"
            ReveilModel.ReveilMode.Semaine -> textEditReveilJoursChoisis.text = "Du lundi au vendredi"
            ReveilModel.ReveilMode.TousLesJours -> textEditReveilJoursChoisis.text = "Tous les jours"
