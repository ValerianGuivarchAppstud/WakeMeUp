...
import com.vguivarc.wakemeup.reveil.adds.AlarmSetter.Companion.ACTION_FIRED
import com.vguivarc.wakemeup.reveil.adds.AlarmSetter.Companion.ACTION_INEXACT_FIRED
...
/*                alarms.getAlarm(id)?.let {
            ...
            AppWakeUp.alarmSetterImpl.removeInexactAlarm(id)
            }
