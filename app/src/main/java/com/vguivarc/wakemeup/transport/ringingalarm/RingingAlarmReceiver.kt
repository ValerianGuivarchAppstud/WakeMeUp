...
import com.vguivarc.wakemeup.domain.internal.AlarmAndroidProvider.Companion.ACTION_FIRED
import com.vguivarc.wakemeup.domain.internal.AlarmAndroidProvider.Companion.ACTION_INEXACT_FIRED
import com.vguivarc.wakemeup.domain.internal.AlarmAndroidProvider.Companion.EXTRA_ID
import timber.log.Timber

class RingingAlarmReceiver : BroadcastReceiver() {
...
/*                alarms.getAlarm(id)?.let {
                ...
                AndroidApplication.alarmAndroidProviderImpl.removeInexactAlarm(id)
            }
            ACTION_INEXACT_FIRED -> {
                ...
                // val id = intent.getIntExtra(EXTRA_ID, -1)
                Timber.e("lolA")
                val intentAlarmReceiver = Intent(context, RingingAlarmService::class.java)
