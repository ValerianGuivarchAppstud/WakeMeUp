...
class MusiquesRecuesFragment : Fragment() {
    ...
    private fun gestionSwitchAttentePassees() {
        ...
        btEnAttente.setOnClickListener {
            if (!btEnAttente.isActivated) {
                ...
                btPassees.setBackgroundColor(ContextCompat.getColor(requireContext(), R.color.texte_desactive))
        ...
        btPassees.setOnClickListener {
            if (!btPassees.isActivated) {
                ...
                btEnAttente.setBackgroundColor(ContextCompat.getColor(requireContext(), R.color.texte_desactive))
    ...
    fun share(song: Song) {
      /*  val action =
            MusiquesRecuesFragmentDirections.actionMusiquesRecuesFragmentToContactsListeShareFragment(
                song
            )
