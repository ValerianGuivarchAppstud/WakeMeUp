...
import kotlinx.android.synthetic.main.fragment_musiques_recues.view.texte_pas_de_musiques_en_attente
import kotlinx.android.synthetic.main.fragment_video.view.pb_main_loader
...
class MusiquesRecuesFragment : Fragment() {
    ...
    private fun gestionSwitchAttentePassees(){
        ...
        btEnAttente.setOnClickListener {
            if (!btEnAttente.isActivated){
                btEnAttente.setBackgroundColor(getResources().getColor(R.color.colorPrimary))
                ...
                btPassees.setTextColor(getResources().getColor(R.color.colorPrimary))
        ...
        btPassees.setOnClickListener {
            if (!btPassees.isActivated){
                btPassees.setBackgroundColor(getResources().getColor(R.color.colorPrimary))
                ...
                btEnAttente.setTextColor(getResources().getColor(R.color.colorPrimary))
    ...
    override fun onCreateView(
        ...
        youTubePlayerView = currentView.youtube_player_view_musiques_recues
