...
//----------------------------------------------------------------//
//CET ADAPTATER EST POUR LES MUSIQUES DANS L'HISTORIQUE DES VIDEOS//
//----------------------------------------------------------------//
...
class SongHistoriqueAdaptater(
    ...
    class SongHistoriqueViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(song: SongHistorique, listener: RecyclerItemClickListener) {
